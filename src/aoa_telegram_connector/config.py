...
ENV_FAMILY_ROOT = "CONNECTOR_FAMILY_ROOT"
ENV_INSTANCE_ROOT = "CONNECTOR_INSTANCE_ROOT"
...
class StorageRoots:
    ...
    def as_dict(self) -> dict[str, str | None]:
        return {
            ENV_FAMILY_ROOT: os.environ.get(ENV_FAMILY_ROOT),
            ENV_INSTANCE_ROOT: os.environ.get(ENV_INSTANCE_ROOT),
